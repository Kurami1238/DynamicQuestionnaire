...
<body>
    <form id="form1" runat="server">
        <div runat="server" id="all" class="col-sm-11 col-md-11 col-lg-11">
            ...
            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#hondouniedit">修改</button>
            <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#hondounigogo">送出</button>
        </div>
            ...
            <div class="modal-dialog" style="background-color: black;">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button runat="server" ID="edit" CssClass="btn btn-dark" Text="修改" OnClick="edit_Click" />
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="hondounigogo" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-modal="true" role="dialog">
            <div class="modal-dialog" style="background-color: black;">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-dark" data-bs-dismiss="modal">關閉</button>
                        <asp:Button runat="server" ID="gogo" CssClass="btn btn-dark" Text="送出" OnClick="gogo_Click" />
                    </div>
                </div>
            </div>
        </div>
